...
></div>
 <!-- NAVBAR
    ================================================== -->
      ...
      <div class="container">
	   ...
	   <div class="nav-collapse collapse">
		  ...
		  <li class="active"><a href=""><h4>Add Photos</h4></a></li>
    ...
    <div class="row">
		...
		<div class="ui-widget">
                <label for="cities"><h4>Select City for Your Photo</h4></label>
...
echo "<script>window.top.location='dreamtrip.php?op=signin&&from=photos'</script>";
}  ?>
