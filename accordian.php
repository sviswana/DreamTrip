...
include 'dbCon.php';
  ...
  <?php echo "<br><h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$city</h1>";?>

<?php 
$q="SELECT round(userRating) FROM Locations WHERE City='$city'";
$r=mysql_query($q);
$row = mysql_fetch_assoc($r);
$rating= $row['round(userRating)'];
while($rating>0) { ?>
<img src="star_on.gif" width="20">
<?php
$rating--;
}
$rating=$row['round(userRating)'];
while(5-$rating>0){ ?>
<img src="star_off.gif" width="20">
<?php $rating++;
}
?>
...
></div>
  ...
  <li ><a href="viewreviews.php?city=<?php echo $_GET['city']; ?> &theme=<?php echo $_GET['theme']; ?>" ><font color="black"><b>View Reviews</b></font></a></li>
</ul>
...
<div>
    <?php
   ?>
   <!--Beginning of carousel or single image-->
   
  <div class="span12 offset12">
    <body>      
        <?php
        include 'dbCon.php';
           $query= "SELECT ImageLink FROM `UserPhotos` WHERE City='$city'";
           $runQuery=mysql_query($query) or die("error");
	   $empty = false;
	  $row=mysql_fetch_assoc($runQuery) or $empty=true;
	  if (!$empty) {
        ?>
	    <div id="myCarousel" class="carousel slide">
	    <div class="carousel-inner">
			<div class="active item" align="center">
        		    <img src="<?php echo $row['ImageLink']; ?>" width='500' height='500'>
                        </div>
			<?php
	...
	?>
	   ...
	   <?php
	    ...
	    else 
	    {
	       ...
	       $loc = "SELECT bigImage from `Locations` WHERE city='$city'";
    $bigloc = mysql_query($loc);
    $result2 = mysql_fetch_array($bigloc);
    $bigImage = $result2['bigImage']; ?>
    ...
    <div class="thumbnail"> <?php
      echo "<img src=$bigImage style='width': 1000px; 'height': 1000px; ?>" ?>
      <h5> No users have added photos for this city! - Be the first to <a href="addphotos.php">upload</a>!</h5>
    </div>
</ul>
		<?php
...
?>	    
 ...
 <div class='span3'>
  ...
  <h3>Share With Friends!</h3>
    ...
    <div class="fb-like" id="fb" data-href="http://jinala.scripts.mit.edu/accordion.php" data-send="false" data-layout="button_count" data-width="500" data-show-faces="false" data-action="like"></div>
...
<script type="text/javascript" src="http://assets.pinterest.com/js/pinit.js"></script>
	<a href="https://twitter.com/share" class="twitter-share-button" id ="twitter" data-url="http://jinala.scripts.mit.edu/accordian.php" data-hashtags="DreamTrip">Tweet</a>
...
<script type="text/javascript">
var sUrl = window.location;
document.getElementById('twitter').setAttribute('data-url', sUrl);
</script>
</div>
   </div>
 </div>
...
<script>(function(d, s, id) {
  ...
  <?php
    if ($theme=="All")
    {
       $sql = "SELECT DISTINCT Attraction, ImageLink, Description from `Attractions` WHERE city='$city'";
    }
    else
    {
        $sql = "SELECT * from `Attractions` WHERE city='$city' and theme='$theme'";
    }
	...
	echo '<div class="container-fluid">';
        ...
        while ($obj = mysql_fetch_array($result))
        {
          ...
          echo "<h3>$attraction</h3>";
          echo "<div>";
          echo "<p>";
          $image = $obj['ImageLink'];
          echo "<img src=$image width='250' height= '250' align= 'left' hspace='25'>";         
